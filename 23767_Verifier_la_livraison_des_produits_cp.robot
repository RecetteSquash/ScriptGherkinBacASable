...
Test Setup
	...
	${_TEST_23767_SETUP}	Get Variable Value	${TEST 23767 SETUP}
	Run Keyword If	${_TEST_SETUP} is not None	${_TEST_SETUP}
	Run Keyword If	${_TEST_23767_SETUP} is not None	${_TEST_23767_SETUP}

Test Teardown
	${_TEST_TEARDOWN}	Get Variable Value	${TEST TEARDOWN}
	${_TEST_23767_TEARDOWN}	Get Variable Value	${TEST 23767 TEARDOWN}
	Run Keyword If	${_TEST_TEARDOWN} is not None	${_TEST_TEARDOWN}
	Run Keyword If	${_TEST_23767_TEARDOWN} is not None	${_TEST_23767_TEARDOWN}

*** Test Cases ***
Vérifier la livraison des produits cp
