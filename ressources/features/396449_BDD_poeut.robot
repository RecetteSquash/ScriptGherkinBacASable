...
BDD poeut
    ...
    Given dadfadazdf "${datatables}[datatable_1]"
    # efaefze
    When dazdad "${docstrings}[docstring_1]"
    # zadfaefaef
...
Test Setup
    ...
    ...                You can define the ${TEST_396449_SETUP} variable with a keyword for setting up this specific test.
    ...                If both are defined, ${TEST_396449_SETUP} will be run after ${TEST_SETUP}.

    ${TEST_SETUP_VALUE} =           Get Variable Value    ${TEST_SETUP}
    ${TEST_396449_SETUP_VALUE} =    Get Variable Value    ${TEST_396449_SETUP}
    IF    $TEST_SETUP_VALUE is not None
        Run Keyword    ${TEST_SETUP}
    END
    IF    $TEST_396449_SETUP_VALUE is not None
        Run Keyword    ${TEST_396449_SETUP}
    END

Test Teardown
    [Documentation]    test teardown
    ...                You can define the ${TEST_TEARDOWN} variable with a keyword for tearing down all your tests.
    ...                You can define the ${TEST_396449_TEARDOWN} variable with a keyword for tearing down this specific test.
    ...                If both are defined, ${TEST_TEARDOWN} will be run after ${TEST_396449_TEARDOWN}.

    ${TEST_396449_TEARDOWN_VALUE} =    Get Variable Value    ${TEST_396449_TEARDOWN}
    ${TEST_TEARDOWN_VALUE} =           Get Variable Value    ${TEST_TEARDOWN}
    IF    $TEST_396449_TEARDOWN_VALUE is not None
        Run Keyword    ${TEST_396449_TEARDOWN}
    END
...
Retrieve Docstrings
    ...
    ${docstring_1} =    Set Variable    dzdzefeff #sjhfvbfbh
