...
Test Setup
    ...
    END
    IF    $TEST_268_SETUP_VALUE is not None
        Run Keyword    ${TEST_268_SETUP}
    END
...
Test Teardown
    ...
    IF    $TEST_268_TEARDOWN_VALUE is not None
        Run Keyword    ${TEST_268_TEARDOWN}
    END
